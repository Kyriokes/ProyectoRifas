          ...
          <main className="px-3 sm:px-10 md:px-24 flex flex-col gap-16 pt-5 pb-10">
              <section className="flex flex-col gap-5">
                  ...
                  <div className="flex flex-col gap-5 md:flex-row">
                      <img
                          src="https://img.freepik.com/foto-gratis/gatito-pared-monocromatica-detras-ella_23-2148955132.jpg"
                          alt=""
                          className="w-screen h-96 sm:h-[700px] md:w-96 md:h-[500px] rounded object-cover"
                      />
                      <div className="flex flex-col gap-5">
                          ...
                          <div>
                              ...
                              <p>
                                  EL CABALLO DE LA FORD <br />
                                  Ford bronco automática 4x4 con cauchos
                                  Goodrich, quema coco, tapicería de piel +
                                  2.000 en la guantera. <br />
                                  ...
                                  Puedes comprar de un boleto en adelante
                                  peeeeeroooo si llevas más de 3 boletos Doblas
                                  los premios en efectivo. <br />
                                  Si llevas más de 10 boletos cuando te ganes la
                                  camioneta te llevamos a los Roques y te damos
                                  2 iPhone 16 pro max! <br />
                                  Valor del boleto 15 dolaritos <br />
                                  Promo: 3 boletos x 30 dolaritos. <br />
                                  Fecha del sorteo viernes 28 de febrero a media
                                  noche por la lott de Medellín. <br />
                                  BUENA SUERTE🙏🏻💚
                              </p>
                          </div>
                      </div>
              ...
              <section className="flex flex-col gap-5">
                      ...
                      <div className="flex h-96 overflow-y-auto flex-wrap gap-2 border border-yellow-500 py-5 items-center rounded">
                          {numbers.length > 0 ? (
                              numbers.map((n, i) => (
                                  <div
                                      key={i}
                                      className="hover:bg-yellow-500 w-16 p-2  text-center rounded"
                                  >
                                      {n}
                                  </div>
                              ))
                  ...
                  <div>
                      ...
                      <div className="flex h-36 overflow-y-auto flex-wrap gap-2 border border-yellow-500 py-5 items-center rounded"></div>
                  </div>
                  <div>
                      ...
                      <input
                          type="text"
                          className="w-full bg-yellow-100 p-1 text-base rounded"
                      />
              ...
              <section className="flex flex-col gap-5">
                  ...
                  <button className="flex justify-center gap-2 bg-yellow-900 rounded hover:bg-yellow-500 p-2">
                      <Search />
                      Buscar
                  </button>
              </section>
